...
import 'atividade6.dart';

class atividade5 extends StatefulWidget {
  const atividade5({Key? key}) : super(key: key);

  @override
  _atividade5State createState() => _atividade5State();
}
...
class _atividade5State extends State<atividade5> {
  ...
  void initAsset() async {
    await player.setSourceAsset('sequencia.mp3');
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Image.asset('assets/icons/oitos.png'),
                        ),
                      ),
                      InkWell(
                        onTap: (() {
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const atividade6(),
                        ),
                      );
                    },
                    color: const Color.fromRGBO(235, 159, 74, 1),

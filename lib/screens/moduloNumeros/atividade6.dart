import 'package:Pedagodino/screens/moduloNumeros/final2.dart';
...
class atividade6 extends StatefulWidget {
  const atividade6({Key? key}) : super(key: key);

  @override
  _atividade6State createState() => _atividade6State();
}
...
class _atividade6State extends State<atividade6> {
  ...
  void initAsset() async {
    await player.setSourceAsset('domino.mp3');
                        ...
                        child: Padding(
                          ...
                          child: RichText(
                            text: const TextSpan(
                                ...
                                children: <TextSpan>[
                                  TextSpan(
                                      text: 'Qual dominó mostra o número '),
                                  TextSpan(
                                      text: '3',
                                      style: TextStyle(
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Image.asset('assets/icons/tresdom.png'),
                        ),
                      ),
                      InkWell(
                        onTap: (() {

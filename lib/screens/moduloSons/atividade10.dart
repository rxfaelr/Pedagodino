...
import 'atividade11.dart';

class atividade10 extends StatefulWidget {
  const atividade10({Key? key}) : super(key: key);
...
class _atividade10State extends State<atividade10> {
  ...
  void initAsset() async {
    await player.setSourceAsset('abacaxi.mp3');
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Image.asset('assets/icons/abacaxi2.png'),
                        ),
                      ),
                    ],
                  ),
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const atividade11(),
                        ),
                      );
                    },
                    color: const Color.fromRGBO(235, 159, 74, 1),

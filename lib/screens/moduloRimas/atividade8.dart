...
import 'atividade9.dart';

class atividade8 extends StatefulWidget {
  const atividade8({Key? key}) : super(key: key);

  @override
  _atividade8State createState() => _atividade8State();
}
...
class _atividade8State extends State<atividade8> {
  ...
  void initAsset() async {
    await player.setSourceAsset('mola.mp3');
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Image.asset('assets/icons/bola.png'),
                        ),
                      ),
                      InkWell(
                        onTap: (() {
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const atividade9(),
                        ),
                      );
                    },
                    color: const Color.fromRGBO(235, 159, 74, 1),

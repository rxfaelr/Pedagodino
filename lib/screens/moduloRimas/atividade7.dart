...
import 'atividade8.dart';

class atividade7 extends StatefulWidget {
  const atividade7({Key? key}) : super(key: key);

  @override
  _atividade7State createState() => _atividade7State();
}
...
class _atividade7State extends State<atividade7> {
  ...
  void initAsset() async {
    await player.setSourceAsset('leao.mp3');
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Image.asset('assets/icons/aviao.png'),
                        ),
                      ),
                    ],
                  ),
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const atividade8(),
                        ),
                      );
                    },
                    color: const Color.fromRGBO(235, 159, 74, 1),

import 'package:Pedagodino/screens/moduloLetras/final1.dart';
...
class atividade3 extends StatefulWidget {
  const atividade3({Key? key}) : super(key: key);

  @override
  _atividade3State createState() => _atividade3State();
}
...
class _atividade3State extends State<atividade3> {
  ...
  void initAsset() async {
    await player.setSourceAsset('fada.mp3');
                        ...
                        child: Padding(
                          ...
                          child: RichText(
                            text: const TextSpan(
                                ...
                                children: <TextSpan>[
                                  TextSpan(text: 'Qual palavra '),
                                  TextSpan(
                                      text: 'NÃO ',
                                      style: TextStyle(
                                          fontWeight: FontWeight.bold)),
                                  TextSpan(text: 'começa com a letra D?'),
                                ]),
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Image.asset('assets/icons/fada.png'),
                        ),
                      ),
                    ],
                  ),

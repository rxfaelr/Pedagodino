...
import 'package:Pedagodino/screens/moduloLetras/atividade1.dart';
...
class letrasScreen extends StatefulWidget {
  ...
  @override
  _letrasScreenState createState() => _letrasScreenState();
}
                ...
                Expanded(
                  child: ListView.separated(
                    ...
                    itemBuilder: (_, int index) {
                      return CourseContainer(course: courses[0]);
                    },
                    itemCount: 1,
                  ),
                ),
    ...
    return GestureDetector(
      onTap: (() {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => const atividade1(),
          ),
        );
      }),
      child: Container(
